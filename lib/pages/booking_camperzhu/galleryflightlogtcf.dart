...
class GalleryfligHtlogtcf extends StatefulWidget {
  ...
  @override
  State<GalleryfligHtlogtcf> createState() => _GalleryfligHtlogtcf();
}

class _GalleryfligHtlogtcf extends State<GalleryfligHtlogtcf> {
  @override
  void dispose() {
    super.dispose();
  }
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              boxShadow: [
                                BoxShadow(
                                  blurRadius: 4,
                                  color: Color(0xffFD8C23).withOpacity(0.8),
                                  offset: Offset(0, 2),
                                ),
                              ],
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.raleway(
                              fontSize: 16,
                              fontWeight: FontWeight.w500,
                              color: Color(0xFFfe6a5e),
                            ),
                          ),
                        ],
                      ),
                      Text(
                        ' gems for expedited exposure?',
                        style: GoogleFonts.raleway(
                          fontSize: 16,
                          fontWeight: FontWeight.w500,
                          color: Color(0xFF261c3f),
