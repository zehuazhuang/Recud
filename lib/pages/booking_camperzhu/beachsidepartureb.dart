...
class _BeachsidePartureb extends State<BeachsidePartureb> {
  ...
  final TextEditingController _backpactrip = TextEditingController();
  final TextEditingController _farewelladvice = TextEditingController();
  bool beaconxz = false;
  @override
  void dispose() {
    super.dispose();
