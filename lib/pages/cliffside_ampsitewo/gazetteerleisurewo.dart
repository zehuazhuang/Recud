...
class GazetteerlEisurewo extends StatefulWidget {
  const GazetteerlEisurewo({super.key});
                ...
                SingleChildScrollView(
                  ...
                  child: Flex(
                    ...
                    children: [
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: GoogleFonts.roboto(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        color:
                                        _ocabintyp == 1.0?Color(0xffffffff):
                                         Color(0xFF958cc1),
                                      ),
                                    ),
                                    Container(
                                    ...
                                    Container(
                                      ...
                                      color:_ocabintyp == 1.0?Color(0xffffffff): Color(0xff392c59),
                                    ),
                                  ],
                                ),
                              ),
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: GoogleFonts.roboto(
                                        fontSize: 16,
                                        fontWeight: FontWeight.w400,
                                        color:  _ocabintyp == 2.0?Color(0xffffffff):
                                         Color(0xFF958cc1),
                                      ),
                                    ),
                                    Container(
                                    ...
                                    Container(
                                      ...
                                      color:_ocabintyp == 2.0?Color(0xffffffff): Color(0xff392c59),
                                    ),
                                  ],
                                ),
                              ),
                      ...
                      Padding(
                        padding:  EdgeInsets.only(left: 16,right: 
                        _ocabintyp==1.0?
                        10:16),
                        child: Wrap(
                          runSpacing: 16,
